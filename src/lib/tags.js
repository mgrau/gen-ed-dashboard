...
export const TAG_META = {
  ...
  goal_communication:{ label: 'Communication & Expression',    short: 'COM',  color: 'bg-green-100 text-green-700 border-green-300' },
  goal_civic:        { label: 'Civic Engagement',              short: 'CIV',  color: 'bg-purple-100 text-purple-700 border-purple-300' },
  natural_science_lab:{ label: 'Natural Science + Lab',        short: 'NSL',  color: 'bg-teal-100 text-teal-700 border-teal-300' },
