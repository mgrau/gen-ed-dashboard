...
<main class="flex h-[calc(100vh-96px)] overflow-hidden">
  <!-- Left: Requirements Tracker -->
  <aside class="w-[360px] min-w-[280px] border-r border-gray-200 overflow-y-auto bg-white">
  ...
  <!-- Right: Course Pool -->
  <aside class="w-[380px] min-w-[300px] border-l border-gray-200 overflow-y-auto bg-white flex flex-col">
    <div class="px-3 pt-4 pb-2 border-b border-gray-100">
